(function ($) {
  ...
  var adjustPageTitle = function () {
    ...
    $("#eskimo-main-container")
      .find(".eskimo-page-title")
      .css("margin-right", -distance);
    $("#eskimo-main-container")
      .find(".eskimo-page-title")
      .css("padding-right", distance);
  ...
  $("#eskimo-main-menu")
    ...
    .on("click", function () {
      ...
      if (nxtLink.is("ul") && !nxtLink.is(":visible")) {
        $("#eskimo-main-menu")
          .find(".eskimo-menu-ul > li > ul:visible")
          .slideUp(300);
        nxtLink.slideDown(300);
        $("#eskimo-main-menu")
          .find(".eskimo-menu-ul > li:has(ul) > a")
          .removeClass("eskimo-menu-up")
          .addClass("eskimo-menu-down");
