+(function (t, e, i) {
  ...
  e.fn.rrssb = function (t) {
    ...
    (r.emailSubject = r.emailSubject || r.title),
      (r.emailBody =
        r.emailBody ||
        (r.description ? r.description : "") + (r.url ? "\n\n" + r.url : ""));
    for (var s in r) r.hasOwnProperty(s) && r[s] !== i && (r[s] = a(r[s]));
    r.url !== i &&
      (e(this)
        .find(".rrssb-facebook a")
        .attr("href", "https://www.facebook.com/sharer/sharer.php?u=" + r.url),
      e(this)
        .find(".rrssb-tumblr a")
        .attr(
          "href",
          "http://tumblr.com/share/link?url=" +
            r.url +
            (r.title !== i ? "&name=" + r.title : "") +
            (r.description !== i ? "&description=" + r.description : "")
        ),
      e(this)
        ...
        .attr(
          ...
          "http://www.linkedin.com/shareArticle?mini=true&url=" +
            r.url +
            (r.title !== i ? "&title=" + r.title : "") +
            (r.description !== i ? "&summary=" + r.description : "")
        ),
      e(this)
      ...
      e(this)
        ...
        .attr(
          ...
          "https://news.ycombinator.com/submitlink?u=" +
            r.url +
            (r.title !== i ? "&text=" + r.title : "")
        ),
      e(this)
        .find(".rrssb-vk a")
        .attr("href", "https://vk.com/share.php?url=" + r.url),
      e(this)
        .find(".rrssb-reddit a")
        .attr(
          "href",
          "http://www.reddit.com/submit?url=" +
            r.url +
            (r.description !== i ? "&text=" + r.description : "") +
            (r.title !== i ? "&title=" + r.title : "")
        ),
      e(this)
      ...
      e(this)
        ...
        .attr(
          ...
          "http://pinterest.com/pin/create/button/?url=" +
            r.url +
            (r.image !== i ? "&amp;media=" + r.image : "") +
            (r.description !== i ? "&description=" + r.description : "")
        ),
      e(this)
        .find(".rrssb-pocket a")
        .attr("href", "https://getpocket.com/save?url=" + r.url),
      e(this).find(".rrssb-github a").attr("href", r.url),
      ...
      (r.emailAddress !== i || r.emailSubject) &&
        e(this)
          .find(".rrssb-email a")
          .attr(
            "href",
            "mailto:" +
              ...
              "?" +
              (r.emailSubject !== i ? "subject=" + r.emailSubject : "") +
      ...
      e(".rrssb-buttons").each(function (t) {
        ...
        if (c === r.length) {
          var d = 42 * c,
            u = i.width();
          u > d + o &&
            (i.removeClass("small-format"), s.eq(0).removeClass("small"), h());
        } else {
